...
import './CompetitionEditor.dart';
import 'package:maherteacher/services/firestore_service.dart';
import '../components/const.dart';
import '../components/drawer.dart';
class ListOfCompetition extends StatefulWidget {
...
class _CompetitionEditorState extends State<ListOfCompetition> {
  ...
  getInitData() async{
    ...
    var tempQuestions = await FirestoreService().getCompetitions();
    setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Container(
        ...
        Center(child: Text("المسابقات", style: TextStyle(fontWeight: FontWeight.bold, fontSize:25),),),
        SizedBox(height: 20,),
        Expanded(child: ListView(children: <Widget>[
         ...
         SizedBox(height: 25,),
          ...
          child : RaisedButton(
            ...
            .push(new MaterialPageRoute(builder: (BuildContext context) => CompetitionEditor()));
            },
            child: Text("إضافة مسابقة", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white),),)
          ),
    ...
    return Column(children: <Widget>[
      ListTile(
          ...
          trailing: InkWell(
            ...
            onTap: (){
              Navigator.push(context,MaterialPageRoute(builder: (context) => CompetitionEditor(statusOfEditor: "edit",itemId: id,)),);
            }
            ,),
          ),
          Divider(),
